...
class acf_field_slider extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Slider', 'acf-slider');
	...
	*/
	...
	function render_field_options( $field ) {
		...
		*/
		...
		acf_render_field_option( $field, array(
			'label'			=> __('Max','acf-slider'),
			'instructions'	=> __('Set the maximum value','acf-slider'),
			'type'			=> 'number',
			'name'			=> 'max'
		));
		
		acf_render_field_option( $field, array(
			'label'			=> __('Min','acf-slider'),
			'instructions'	=> __('Set the mainimum value','acf-slider'),
			'type'			=> 'number',
			'name'			=> 'min'
		));
		acf_render_field_option( $field, array(
			'label'			=> __('Step','acf-slider'),
			'instructions'	=> __('Set the step value','acf-slider'),
			'type'			=> 'number',
			'name'			=> 'step'
		));
		acf_render_field_option( $field, array(
			'label'			=> __('Value','acf-slider'),
			'instructions'	=> __('Set the default value','acf-slider'),
			'type'			=> 'number',
			'name'			=> 'default_value'
		));
		...
		*/
		?>
			<script  type='text/javascript' >
				jQuery(function() {
				  jQuery("#<?php echo esc_attr($field['id']);?>-slider").slider({
		...
		echo'<div class="slider" id="'.esc_attr($field['id']).'-slider"></div>';
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_register_style( 'bootstrap', plugins_url( 'acf-slider-field/css/jquery-ui-1.10.0.custom.css' ) );
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-slider-field'),
		}
